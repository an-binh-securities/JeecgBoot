<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="Danh sách lựa chọn người dùng" width="1000px" @ok="handleSubmit" destroyOnClose @openChange="handleOpenChange">
